...
public class Conexion {
    ...
    public void Modificar_Dato(String tabla, String correo, String Nuevo_correo) throws SQLException {
        String Sentencia = "UPDATE " + tabla + " SET Correo = '" + Nuevo_correo + "' WHERE DNI = '" + correo + "'";
    }

    //----------------------------------------------------------
    public void Insertar_Dato(String tabla, String correo, int edad, boolean opcion) throws SQLException {
        String Sentencia = "INSERT INTO " + tabla + " VALUES ('" + correo + "'," + "'" + edad + "','" + opcion + "')";
    }
